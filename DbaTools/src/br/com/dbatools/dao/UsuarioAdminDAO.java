...
public class UsuarioAdminDAO {
	...
	public void salvar(UsuarioAdmin p) throws SQLException {
	...
	public ArrayList<UsuarioAdmin> listar(String user, String computador) throws SQLException {
		StringBuilder sql = new StringBuilder();
		int i = 1;
		...
		ArrayList<UsuarioAdmin> itens = new ArrayList<UsuarioAdmin>();
	...
	public void excluir(UsuarioAdmin p) throws SQLException {
		StringBuilder sql = new StringBuilder();
    ...
    public void editar(UsuarioAdmin p) throws SQLException {
	StringBuilder sql = new StringBuilder();
