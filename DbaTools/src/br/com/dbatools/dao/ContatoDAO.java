...
public class ContatoDAO {
	...
	public void salvar(Contato p) throws SQLException {
	...
	public ArrayList<Contato> listar(String user, String computador) throws SQLException {
		StringBuilder sql = new StringBuilder();
		int i = 1;
                ...
                sql.append(" U.COD_EMPRESA = (select cod_empresa from tb_usuario where usuario = ?)  ");
		...
		ArrayList<Contato> itens = new ArrayList<Contato>();
	...
	public void excluir(Contato p) throws SQLException {
		StringBuilder sql = new StringBuilder();
    ...
    public void editar(Contato p) throws SQLException {
	StringBuilder sql = new StringBuilder();
