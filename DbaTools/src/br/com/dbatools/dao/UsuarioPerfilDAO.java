...
public class UsuarioPerfilDAO {
	...
	public void salvar(UsuarioPerfil p) throws SQLException {
	...
	public ArrayList<UsuarioPerfil> listar(String user, String computador) throws SQLException {
		StringBuilder sql = new StringBuilder();
		int i = 1;
                ...
                sql.append(" U.COD_USUARIO = (select cod_usuario from tb_usuario where usuario = ?)  ");
		...
		ArrayList<UsuarioPerfil> itens = new ArrayList<UsuarioPerfil>();
	...
	public void excluir(UsuarioPerfil p) throws SQLException {
		StringBuilder sql = new StringBuilder();
    ...
    public void editar(UsuarioPerfil p) throws SQLException {
	StringBuilder sql = new StringBuilder();
